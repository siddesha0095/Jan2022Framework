...
//		searchResultsPage = accPage.doSearch("MacBook");
//		productInfoPage = searchResultsPage.selectProduct("MacBook Pro");
//		productInfoPage.enterQuantityAddtoCart(2);
//		
//		
//	}
	
	@Test
	public void addTocartTestSuccessMessageTest() {
		
		searchResultsPage = accPage.doSearch("MacBook");
		productInfoPage = searchResultsPage.selectProduct("MacBook Pro");
		//productInfoPage.enterQuantityAddtoCart(2);
		String actulaMess=productInfoPage.enterQuantityAddtoCart(2);
	//	String expectedMes=Success: You have added MacBook Pro to your shopping cart!
		
		Assert.assertEquals(actulaMess,"Success: You have added MacBook Pro to your shopping cart!\n"+ "×");
