...
public class ProductInfoPage {
	...
	// assignemen - enter quantity and click
	private By quantity= By.xpath("//input[@name='quantity']");
	private By addTocart=By.xpath("//button[@id='button-cart']");
	//private By successMess=By.xpath("//div[@class='alert alert-success alert-dismissible']");
...
//		Ex Tax: $2,000.00
	...
	// assignment
	public String enterQuantityAddtoCart(int noOfQunatity) {
		eleUtil.doSendKeys(quantity, "4");
		...
		return eleUtil.doElementGetText(successMessg).trim();
		}
